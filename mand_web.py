...
# ==========================================
# ⚙️ CONFIG (GÜVENLİ YÖNTEM - SECRETS)
# ==========================================
# API anahtarını kodun içine yazmıyoruz. 
# Lokal çalışırken .streamlit/secrets.toml dosyasından, 
# İnternetteyken Streamlit Cloud Settings -> Secrets kısmından okur.
...
if audio_bytes:
    ...
    if st.session_state.last_audio_hash != h:
        ...
        try:
            # Sesi dosyaya yazmadan bellek üzerinden gönderiyoruz
            ...
            st.error("Microphone connection error. Try again!")
...
if final_text:
    ...
    try:
        # Llama 3.1 üzerinden cevap alıyoruz
        ...
        if "429" in str(e):
            st.warning("Whoa! Too many requests. Wait 5 seconds.")
        else:
